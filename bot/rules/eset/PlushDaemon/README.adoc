...
= PlushDaemon -- Indicators of Compromise

== PlushDaemon compromises network devices for adversary-in-the-middle attacks

The blog post about PlushDaemon compromising network devices for
adversary-in-the-middle attacks is available on WeLiveSecurity at
...
|`++8.212.132.120++` |`++ds20221202.dsc.wcsset.com++`|2024-07-12 |DNS/Hijacking node.
|`++47.242.198.250++` |`++test.dsc.wcsset.com++`|2024-07-12 |DNS/Hijacking node.
|===

== China-aligned PlushDaemon compromises supply chain of Korean VPN service
